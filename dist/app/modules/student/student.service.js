...
const updateStudentIntoDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const modifiedUpdatedData = Object.assign({}, restOfData);
...
const deleteStudentFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!deletedStudent) {
            throw new AppError_1.AppError(400, 'Failed to delete student');
        }
        const deletedUser = yield user_model_1.User.findOneAndUpdate({ id }, { isDeleted: true }, { new: true, session });
        if (!deletedUser) {
            throw new AppError_1.AppError(400, 'Failed to delete user');
        }
